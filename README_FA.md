...
🟡 اگر تعداد کانفیگ هایی که دریافت میکنید زیاد است، میتوانید با استفاده از `?n=xxx` در انتهای لینک سابسکریپشن خود، تعداد xxx کانفیگ به صورت تصادفی، به جای کل کانفیگ‌ها دریافت کنید. به عنوان مثال:
